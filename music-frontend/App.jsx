...
import './App.css'
import { MOCK_RESULT_DATA } from './mockData';
...
function App() {
  ...
  // --- FOR UI TESTING ONLY ---
  // Uncomment the following useEffect block to load mock data on start.
  // This allows you to work on the results display without the backend.
  useEffect(() => {
    setResult(MOCK_RESULT_DATA);
    setStatus('Displaying mock data for UI testing.');
  }, []);
